    ...
    <section className="pt-[93px] pb-[113px] max-w-[1440px] mx-auto">
      ...
      >
        <div>
          ...
          <p className="md:text-tiny text-gray w-[196px] mt-3 mb-6  max-lg:w-auto">
            Easiest way to healthy life by buying your favorite plants
          </p>
          <Button href="/products" text="See more" onClick={() => {}} />
        </div>
        <div
          className="
            grid grid-cols-3
        ...
        >
          {plantList.map((plant, index) => {
            return (
              <Slide key={index} index={index} direction="right">
                <PlantCard
                  image={plant.image}
                  name={plant.name}
                  price={plant.price}
