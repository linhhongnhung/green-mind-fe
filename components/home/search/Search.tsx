...
const Search: React.FC = () => {
  ...
  return (
    <section className="max-w-[1440px] mx-auto mt-4">
      <div
        className="
            min-h-[512px] max-w-[1280px] rounded-[24px]
            mx-24 pl-12
            bg-primary
            flex
            max-lg:pr-12
      ...
      >
        <div>
          <h2
            className="
                text-large font-extrabold leading-[64px]
                mt-12 mb-6
                max-xl:text-[3rem]
                max-sm:text-base"
          >
              ...
              if (index !== statisticListLength - 1) {
                return (
                  <React.Fragment key={index}>
                    <Statistics amount={item.amount} type={item.type} />
          ...
          <form onSubmit={handleSearch}>
            <button
              className="
                w-12 h-12 bg-primary rounded-[12px]
                absolute
                ml-[393px] mt-2
