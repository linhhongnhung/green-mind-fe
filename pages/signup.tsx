...
export default function Signup() {
  ...
  return (
    <main className="bg-[url('../public/img/login_bg.png')] bg-center bg-cover py-8">
      ...
      >
        <form
          className="max-w-[1280px] min-w-[560px] my-auto mr-12 py-12 rounded-[16px] bg-white
        ...
        >
          <h1 className="text-base font-bold mb-8 text-center max-md:text-[1.5rem]">Creat an account</h1>
