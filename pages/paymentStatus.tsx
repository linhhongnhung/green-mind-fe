...
import { createOrderAfterPayment, generateVnpayUrl } from "@/api/api";
...
const PaymentStatus = () => {
  ...
  const handlePaymentSuccess = async (vnp_ResponseCode: any) => {
    ...
    if (vnp_ResponseCode === "00") {
      ...
      toast.error('Order failed!', { autoClose: 1000, position: toast.POSITION.TOP_CENTER });
      router.push("/cart")
    }
  };
  ...
  return (
    <main className="max-w-[1440px] mx-auto">
      <section className="max-w-[1280px] mx-24 my-12 flex flex-col items-center">
        <h2 className="font-bold text-base">Ready to pay for order with VNPAY?</h2>
